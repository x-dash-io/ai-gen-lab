    ...
    <div className="section">
      <div className="container-shell" style={{ maxWidth: "560px" }}>
        <header className="section-head" data-reveal>
          ...
          <p className="section-copy">Access your premium learning environment and operator toolkit.</p>
        </header>
        ...
        <div data-reveal style={{ animationDelay: "0.1s" }}>
          ...
          <p style={{ marginTop: "0.9rem", fontSize: "0.93rem" }}>
            New here?{" "}
            <Link href="/sign-up" style={{ color: "var(--accent-strong)", fontWeight: 700 }}>
              Create your account
            </Link>
          </p>
        </div>
